...
Encoder encImplementWheel(encImplementWheel_PIN_X, encImplementWheel_PIN_Y, SINGLE /* or HALFQUAD or FULLQUAD */, 250 /* Noise and Debounce Filter (default 0) */); // - Example for STM32, check datasheet for possible Timers for Encoder mode. TIM_CHANNEL_1 and TIM_CHANNEL_2 only
Encoder encHorizActuator(encHorizActuator_PIN_X, encHorizActuator_PIN_Y, SINGLE /* or HALFQUAD or FULLQUAD */, 250 /* Noise and Debounce Filter (default 0) */); // - Example for STM32, check datasheet for possible Timers for Encoder mode. TIM_CHANNEL_1 and TIM_CHANNEL_2 only
Encoder encDrawbarActuator(encDrawbarActuator_PIN_X, encDrawbarActuator_PIN_Y, SINGLE /* or HALFQUAD or FULLQUAD */, 250 /* Noise and Debounce Filter (default 0) */); // - Example for STM32, check datasheet for possible Timers for Encoder mode. TIM_CHANNEL_1 and TIM_CHANNEL_2 only
...
// Encoder wheel:
long encoderWheelVal = 0;       // Deprecated.
long encImplementWheelVal = 0;
long encHorizActuatorVal = 0;
long encDrawbarActuatorVal = 0;
...
double myGPSdata_array[500][2];  // 2D array to store act_lat and act_lon.
