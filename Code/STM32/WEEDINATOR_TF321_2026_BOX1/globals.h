...
extern int RH_LIMITER;
extern int LH_LIMITER;
...
extern float throtA_differential;
...
extern double myGPSdata_array[5][2];  // 2D array to store act_lat and act_lon
...
extern bool SBUS_disconnect_flag;
