...
--
-- Host: localhost:3306
-- Generation Time: Jul 29, 2026 at 03:00 PM
...
--
-- Table structure for table `des_coords`
--

CREATE TABLE `des_coords` (
  `ID` int(10) NOT NULL,
...
--
-- Indexes for table `des_coords`
--
ALTER TABLE `des_coords`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `des_coords`
--
ALTER TABLE `des_coords`
