...
$query12="SELECT * FROM control_room ORDER BY id DESC LIMIT 1";
$result12=mysql_query($query12);
while($row12=mysql_fetch_array($result12))
   {  
   $id = $row12['ID'];
   $time_stamp = $row12['TIME'];
   $act_lat = $row12['des_lat'];
   $act_lon = $row12['des_lon'];
   }
   
$query13="SELECT * FROM control_room ORDER BY id DESC LIMIT 2";
$result13=mysql_query($query13);
while($row13=mysql_fetch_array($result13))
   {  
   $id_previous = $row12['ID'];
   $time_stamp_previous = $row13['TIME'];
   $lat_previous = $row13['des_lat'];
   $lon_previous = $row13['des_lon'];
   }
...
<table width="580">
  <tr><span class="style2">
    <td><div align="center"><span class="style3">WEEDINATOR Control Room</td>
  </tr>
</table>
...
<table width="680" border="1" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="9%"><span class="style1"><div align="center">Des_Lat </div></td>
		<td width="8%"><span class="style1"><div align="center">Des_Lon </div></td>
	</tr>
</table>
<table width="680" border="1" cellspacing="0" cellpadding="0"> 
...
?>
 ...
 <td bgcolor="#ccffcd" width="9%"><div align="center"><span class="style1"><? echo $rows['des_lat']; ?></span></td>
 <td bgcolor="#ffccd9" width="8%"><div align="center"><span class="style1"><? echo $rows['des_lon']; ?></span></td>
 </tr>
