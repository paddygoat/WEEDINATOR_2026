...
$tableName="des_coords"; // Table name
...
if (isset($_POST['coords_data']))
{
    ...
    try
    {
        ...
        // Using a prepared statement is a good practice even without parameters
        ...
        // echo "All rows from the table '" . $tableName . "' have been deleted successfully.";
